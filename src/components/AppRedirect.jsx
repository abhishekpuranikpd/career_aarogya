    ...
    const steps = [
      {
        ...
        description: (
          <div className="flex flex-col items-start gap-2">
            <span>Get the Aarogya Aadhar app from the Google Play Store.</span>
            <a
              href="https://play.google.com/store/apps/details?id=com.aarogyaaadhar.app"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 px-4 py-2 mt-1 text-sm font-semibold text-white bg-blue-600 hover:bg-blue-700 rounded-lg shadow-sm transition-colors"
            >
        ...
        >
          ...
          <div className="px-6 py-10 sm:px-12 sm:py-12 bg-white">
            ...
            <motion.div
              ...
              className="mt-12 bg-slate-50 p-6 sm:p-8 rounded-2xl border border-slate-100 shadow-inner"
            >
              ...
              <div className="relative w-full overflow-hidden rounded-xl shadow-md border border-slate-200" style={{ paddingTop: '56.25%' }}>
                <iframe
                  className="absolute top-0 left-0 w-full h-full"
                  src="https://www.youtube.com/embed/KyPmNZnZ55A?si=7DY0hHgik09rqd_f"
